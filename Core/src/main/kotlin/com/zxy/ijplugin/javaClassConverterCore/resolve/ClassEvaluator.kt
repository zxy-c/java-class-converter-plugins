...
import com.zxy.ijplugin.javaClassConverterCore.resolve.utils.ObviousType

interface ClassEvaluatorProvider {
    companion object {
        @JvmField
        val EXTENSION_POINT =
            ExtensionPointName<ClassEvaluatorProvider>("com.zxy.ijplugin.javaClassConverterCore.classEvaluatorProvider")
    }
